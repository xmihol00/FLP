...
training_data = {
    ...
    "penguins_small": np.array([
        [39.1, 18.7, 181.0, 3750.0, 1.0, 'Torgersen'],
        [39.5, 17.4, 186.0, 3800.0, 0.0, 'Torgersen'],
        [40.3, 18.0, 195.0, 3250.0, 0.0, 'Torgersen'],
        [39.3, 20.6, 190.0, 3650.0, 1.0, 'Torgersen'],
        [39.2, 19.6, 195.0, 4675.0, 1.0, 'Torgersen'],
        [41.1, 17.6, 182.0, 3200.0, 0.0, 'Torgersen'],
        [42.5, 20.7, 197.0, 4500.0, 1.0, 'Torgersen'],
        [46.0, 21.5, 194.0, 4200.0, 1.0, 'Torgersen'],
        [37.8, 18.3, 174.0, 3400.0, 0.0, 'Biscoe'],
        [37.7, 18.7, 180.0, 3600.0, 1.0, 'Biscoe'],
        [35.9, 19.2, 189.0, 3800.0, 0.0, 'Biscoe'],
        [38.2, 18.1, 185.0, 3950.0, 1.0, 'Biscoe'],
        [38.8, 17.2, 180.0, 3800.0, 1.0, 'Biscoe'],
        [35.3, 18.9, 187.0, 3800.0, 0.0, 'Biscoe'],
        [37.9, 18.6, 172.0, 3150.0, 0.0, 'Biscoe'],
        [39.5, 16.7, 178.0, 3250.0, 0.0, 'Dream'],
        [37.2, 18.1, 178.0, 3900.0, 1.0, 'Dream'],
        [39.5, 17.8, 188.0, 3300.0, 0.0, 'Dream'],
        [40.9, 18.9, 184.0, 3900.0, 1.0, 'Dream'],
        [36.4, 17.0, 195.0, 3325.0, 0.0, 'Dream'],
        [39.2, 21.1, 196.0, 4150.0, 1.0, 'Dream'],
        [38.8, 20.0, 190.0, 3950.0, 1.0, 'Dream'],
        [42.2, 18.5, 180.0, 3550.0, 0.0, 'Dream'],
        [37.6, 19.3, 181.0, 3300.0, 0.0, 'Dream'],
        [39.8, 19.1, 184.0, 4650.0, 1.0, 'Dream'],
        [36.5, 18.0, 182.0, 3150.0, 0.0, 'Dream'],
        [40.8, 18.4, 195.0, 3900.0, 1.0, 'Dream'],
        [36.0, 18.5, 186.0, 3100.0, 0.0, 'Dream'],
        [44.1, 19.7, 196.0, 4400.0, 1.0, 'Dream'],
        [37.0, 16.9, 185.0, 3000.0, 0.0, 'Dream'],
        [39.6, 18.8, 190.0, 4600.0, 1.0, 'Dream'],
        [41.1, 19.0, 182.0, 3425.0, 1.0, 'Dream'],
        [36.0, 17.9, 190.0, 3450.0, 0.0, 'Dream'],
        [42.3, 21.2, 191.0, 4150.0, 1.0, 'Dream']
    ]),
    "penguins": np.array([
        [39.1, 18.7, 181.0, 3750.0, 1.0, 'Torgersen'],
        [39.5, 17.4, 186.0, 3800.0, 0.0, 'Torgersen'],
        [40.3, 18.0, 195.0, 3250.0, 0.0, 'Torgersen'],
        [36.7, 19.3, 193.0, 3450.0, 0.0, 'Torgersen'],
        [39.3, 20.6, 190.0, 3650.0, 1.0, 'Torgersen'],
        [38.9, 17.8, 181.0, 3625.0, 0.0, 'Torgersen'],
        [39.2, 19.6, 195.0, 4675.0, 1.0, 'Torgersen'],
        [41.1, 17.6, 182.0, 3200.0, 0.0, 'Torgersen'],
        [38.6, 21.2, 191.0, 3800.0, 1.0, 'Torgersen'],
        [34.6, 21.1, 198.0, 4400.0, 1.0, 'Torgersen'],
        [36.6, 17.8, 185.0, 3700.0, 0.0, 'Torgersen'],
        [38.7, 19.0, 195.0, 3450.0, 0.0, 'Torgersen'],
        [42.5, 20.7, 197.0, 4500.0, 1.0, 'Torgersen'],
        [34.4, 18.4, 184.0, 3325.0, 0.0, 'Torgersen'],
        [46.0, 21.5, 194.0, 4200.0, 1.0, 'Torgersen'],
        [37.8, 18.3, 174.0, 3400.0, 0.0, 'Biscoe'],
        [37.7, 18.7, 180.0, 3600.0, 1.0, 'Biscoe'],
        [35.9, 19.2, 189.0, 3800.0, 0.0, 'Biscoe'],
        ...
        [38.8, 17.2, 180.0, 3800.0, 1.0, 'Biscoe'],
        [35.3, 18.9, 187.0, 3800.0, 0.0, 'Biscoe'],
        [40.6, 18.6, 183.0, 3550.0, 1.0, 'Biscoe'],
        [40.5, 17.9, 187.0, 3200.0, 0.0, 'Biscoe'],
        [37.9, 18.6, 172.0, 3150.0, 0.0, 'Biscoe'],
        [40.5, 18.9, 180.0, 3950.0, 1.0, 'Biscoe'],
        [39.5, 16.7, 178.0, 3250.0, 0.0, 'Dream'],
        [37.2, 18.1, 178.0, 3900.0, 1.0, 'Dream'],
        [39.5, 17.8, 188.0, 3300.0, 0.0, 'Dream'],
        [40.9, 18.9, 184.0, 3900.0, 1.0, 'Dream'],
        ...
        [36.0, 17.9, 190.0, 3450.0, 0.0, 'Dream'],
        [42.3, 21.2, 191.0, 4150.0, 1.0, 'Dream'],
        [39.6, 17.7, 186.0, 3500.0, 0.0, 'Biscoe'],
        [40.1, 18.9, 188.0, 4300.0, 1.0, 'Biscoe'],
        [35.0, 17.9, 190.0, 3450.0, 0.0, 'Biscoe'],
        [42.0, 19.5, 200.0, 4050.0, 1.0, 'Biscoe'],
        [34.5, 18.1, 187.0, 2900.0, 0.0, 'Biscoe'],
        [41.4, 18.6, 191.0, 3700.0, 1.0, 'Biscoe'],
        [39.0, 17.5, 186.0, 3550.0, 0.0, 'Biscoe'],
        [40.6, 18.8, 193.0, 3800.0, 1.0, 'Biscoe'],
        [36.5, 16.6, 181.0, 2850.0, 0.0, 'Biscoe'],
        [37.6, 19.1, 194.0, 3750.0, 1.0, 'Biscoe'],
        [35.7, 16.9, 185.0, 3150.0, 0.0, 'Biscoe'],
        [41.3, 21.1, 195.0, 4400.0, 1.0, 'Biscoe'],
        [37.6, 17.0, 185.0, 3600.0, 0.0, 'Biscoe'],
        [41.1, 18.2, 192.0, 4050.0, 1.0, 'Biscoe'],
        [36.4, 17.1, 184.0, 2850.0, 0.0, 'Biscoe'],
        [41.6, 18.0, 192.0, 3950.0, 1.0, 'Biscoe'],
        [35.5, 16.2, 195.0, 3350.0, 0.0, 'Biscoe'],
        [41.1, 19.1, 188.0, 4100.0, 1.0, 'Biscoe'],
        [35.9, 16.6, 190.0, 3050.0, 0.0, 'Torgersen'],
        [41.8, 19.4, 198.0, 4450.0, 1.0, 'Torgersen'],
        [33.5, 19.0, 190.0, 3600.0, 0.0, 'Torgersen'],
        [39.7, 18.4, 190.0, 3900.0, 1.0, 'Torgersen'],
        [39.6, 17.2, 196.0, 3550.0, 0.0, 'Torgersen'],
        [45.8, 18.9, 197.0, 4150.0, 1.0, 'Torgersen'],
        [35.5, 17.5, 190.0, 3700.0, 0.0, 'Torgersen'],
        [42.8, 18.5, 195.0, 4250.0, 1.0, 'Torgersen'],
        [40.9, 16.8, 191.0, 3700.0, 0.0, 'Torgersen'],
        [37.2, 19.4, 184.0, 3900.0, 1.0, 'Torgersen'],
        [36.2, 16.1, 187.0, 3550.0, 0.0, 'Torgersen'],
        [42.1, 19.1, 195.0, 4000.0, 1.0, 'Torgersen'],
        [34.6, 17.2, 189.0, 3200.0, 0.0, 'Torgersen'],
        [42.9, 17.6, 196.0, 4700.0, 1.0, 'Torgersen'],
        [36.7, 18.8, 187.0, 3800.0, 0.0, 'Torgersen'],
        [35.1, 19.4, 193.0, 4200.0, 1.0, 'Torgersen'],
        [37.3, 17.8, 191.0, 3350.0, 0.0, 'Dream'],
        [41.3, 20.3, 194.0, 3550.0, 1.0, 'Dream'],
        [36.3, 19.5, 190.0, 3800.0, 1.0, 'Dream'],
        [36.9, 18.6, 189.0, 3500.0, 0.0, 'Dream'],
        [38.3, 19.2, 189.0, 3950.0, 1.0, 'Dream'],
        [38.9, 18.8, 190.0, 3600.0, 0.0, 'Dream'],
        [35.7, 18.0, 202.0, 3550.0, 0.0, 'Dream'],
        [41.1, 18.1, 205.0, 4300.0, 1.0, 'Dream'],
        [34.0, 17.1, 185.0, 3400.0, 0.0, 'Dream'],
        [39.6, 18.1, 186.0, 4450.0, 1.0, 'Dream'],
        [36.2, 17.3, 187.0, 3300.0, 0.0, 'Dream'],
        [40.8, 18.9, 208.0, 4300.0, 1.0, 'Dream'],
        [38.1, 18.6, 190.0, 3700.0, 0.0, 'Dream'],
        [40.3, 18.5, 196.0, 4350.0, 1.0, 'Dream'],
        [33.1, 16.1, 178.0, 2900.0, 0.0, 'Dream'],
        [43.2, 18.5, 192.0, 4100.0, 1.0, 'Dream'],
        [35.0, 17.9, 192.0, 3725.0, 0.0, 'Biscoe'],
        [41.0, 20.0, 203.0, 4725.0, 1.0, 'Biscoe'],
        [37.7, 16.0, 183.0, 3075.0, 0.0, 'Biscoe'],
        [37.8, 20.0, 190.0, 4250.0, 1.0, 'Biscoe'],
        [37.9, 18.6, 193.0, 2925.0, 0.0, 'Biscoe'],
        [39.7, 18.9, 184.0, 3550.0, 1.0, 'Biscoe'],
        [38.6, 17.2, 199.0, 3750.0, 0.0, 'Biscoe'],
        [38.2, 20.0, 190.0, 3900.0, 1.0, 'Biscoe'],
        [38.1, 17.0, 181.0, 3175.0, 0.0, 'Biscoe'],
        [43.2, 19.0, 197.0, 4775.0, 1.0, 'Biscoe'],
        [38.1, 16.5, 198.0, 3825.0, 0.0, 'Biscoe'],
        [45.6, 20.3, 191.0, 4600.0, 1.0, 'Biscoe'],
        [39.7, 17.7, 193.0, 3200.0, 0.0, 'Biscoe'],
        [42.2, 19.5, 197.0, 4275.0, 1.0, 'Biscoe'],
        [39.6, 20.7, 191.0, 3900.0, 0.0, 'Biscoe'],
        [42.7, 18.3, 196.0, 4075.0, 1.0, 'Biscoe'],
        [38.6, 17.0, 188.0, 2900.0, 0.0, 'Torgersen'],
        [37.3, 20.5, 199.0, 3775.0, 1.0, 'Torgersen'],
        [35.7, 17.0, 189.0, 3350.0, 0.0, 'Torgersen'],
        [41.1, 18.6, 189.0, 3325.0, 1.0, 'Torgersen'],
        [36.2, 17.2, 187.0, 3150.0, 0.0, 'Torgersen'],
        [37.7, 19.8, 198.0, 3500.0, 1.0, 'Torgersen'],
        [40.2, 17.0, 176.0, 3450.0, 0.0, 'Torgersen'],
        [41.4, 18.5, 202.0, 3875.0, 1.0, 'Torgersen'],
        [35.2, 15.9, 186.0, 3050.0, 0.0, 'Torgersen'],
        [40.6, 19.0, 199.0, 4000.0, 1.0, 'Torgersen'],
        [38.8, 17.6, 191.0, 3275.0, 0.0, 'Torgersen'],
        [41.5, 18.3, 195.0, 4300.0, 1.0, 'Torgersen'],
        [39.0, 17.1, 191.0, 3050.0, 0.0, 'Torgersen'],
        [44.1, 18.0, 210.0, 4000.0, 1.0, 'Torgersen'],
        [38.5, 17.9, 190.0, 3325.0, 0.0, 'Torgersen'],
        [43.1, 19.2, 197.0, 3500.0, 1.0, 'Torgersen'],
        [36.8, 18.5, 193.0, 3500.0, 0.0, 'Dream'],
        [37.5, 18.5, 199.0, 4475.0, 1.0, 'Dream'],
        [38.1, 17.6, 187.0, 3425.0, 0.0, 'Dream'],
        [41.1, 17.5, 190.0, 3900.0, 1.0, 'Dream'],
        [35.6, 17.5, 191.0, 3175.0, 0.0, 'Dream'],
        [40.2, 20.1, 200.0, 3975.0, 1.0, 'Dream'],
        [37.0, 16.5, 185.0, 3400.0, 0.0, 'Dream'],
        [39.7, 17.9, 193.0, 4250.0, 1.0, 'Dream'],
        [40.2, 17.1, 193.0, 3400.0, 0.0, 'Dream'],
        [40.6, 17.2, 187.0, 3475.0, 1.0, 'Dream'],
        [32.1, 15.5, 188.0, 3050.0, 0.0, 'Dream'],
        [40.7, 17.0, 190.0, 3725.0, 1.0, 'Dream'],
        [37.3, 16.8, 192.0, 3000.0, 0.0, 'Dream'],
        [39.0, 18.7, 185.0, 3650.0, 1.0, 'Dream'],
        [39.2, 18.6, 190.0, 4250.0, 1.0, 'Dream'],
        [36.6, 18.4, 184.0, 3475.0, 0.0, 'Dream'],
        [36.0, 17.8, 195.0, 3450.0, 0.0, 'Dream'],
        [37.8, 18.1, 193.0, 3750.0, 1.0, 'Dream'],
        [36.0, 17.1, 187.0, 3700.0, 0.0, 'Dream'],
        [41.5, 18.5, 201.0, 4000.0, 1.0, 'Dream'],
        [46.5, 17.9, 192.0, 3500.0, 0.0, 'Dream'],
        [50.0, 19.5, 196.0, 3900.0, 1.0, 'Dream'],
        [51.3, 19.2, 193.0, 3650.0, 1.0, 'Dream'],
        [45.4, 18.7, 188.0, 3525.0, 0.0, 'Dream'],
        [52.7, 19.8, 197.0, 3725.0, 1.0, 'Dream'],
        [45.2, 17.8, 198.0, 3950.0, 0.0, 'Dream'],
        [46.1, 18.2, 178.0, 3250.0, 0.0, 'Dream'],
        [51.3, 18.2, 197.0, 3750.0, 1.0, 'Dream'],
        [46.0, 18.9, 195.0, 4150.0, 0.0, 'Dream'],
        [51.3, 19.9, 198.0, 3700.0, 1.0, 'Dream'],
        [46.6, 17.8, 193.0, 3800.0, 0.0, 'Dream'],
        [51.7, 20.3, 194.0, 3775.0, 1.0, 'Dream'],
        [47.0, 17.3, 185.0, 3700.0, 0.0, 'Dream'],
        [52.0, 18.1, 201.0, 4050.0, 1.0, 'Dream'],
        [45.9, 17.1, 190.0, 3575.0, 0.0, 'Dream'],
        [50.5, 19.6, 201.0, 4050.0, 1.0, 'Dream'],
        [50.3, 20.0, 197.0, 3300.0, 1.0, 'Dream'],
        [58.0, 17.8, 181.0, 3700.0, 0.0, 'Dream'],
        [46.4, 18.6, 190.0, 3450.0, 0.0, 'Dream'],
        [49.2, 18.2, 195.0, 4400.0, 1.0, 'Dream'],
        [42.4, 17.3, 181.0, 3600.0, 0.0, 'Dream'],
        [48.5, 17.5, 191.0, 3400.0, 1.0, 'Dream'],
        [43.2, 16.6, 187.0, 2900.0, 0.0, 'Dream'],
        [50.6, 19.4, 193.0, 3800.0, 1.0, 'Dream'],
        [46.7, 17.9, 195.0, 3300.0, 0.0, 'Dream'],
        [52.0, 19.0, 197.0, 4150.0, 1.0, 'Dream'],
        [50.5, 18.4, 200.0, 3400.0, 0.0, 'Dream'],
        [49.5, 19.0, 200.0, 3800.0, 1.0, 'Dream'],
        [46.4, 17.8, 191.0, 3700.0, 0.0, 'Dream'],
        [52.8, 20.0, 205.0, 4550.0, 1.0, 'Dream'],
        [40.9, 16.6, 187.0, 3200.0, 0.0, 'Dream'],
        [54.2, 20.8, 201.0, 4300.0, 1.0, 'Dream'],
        [42.5, 16.7, 187.0, 3350.0, 0.0, 'Dream'],
        [51.0, 18.8, 203.0, 4100.0, 1.0, 'Dream'],
        [49.7, 18.6, 195.0, 3600.0, 1.0, 'Dream'],
        [47.5, 16.8, 199.0, 3900.0, 0.0, 'Dream'],
        [47.6, 18.3, 195.0, 3850.0, 0.0, 'Dream'],
        [52.0, 20.7, 210.0, 4800.0, 1.0, 'Dream'],
        [46.9, 16.6, 192.0, 2700.0, 0.0, 'Dream'],
        [53.5, 19.9, 205.0, 4500.0, 1.0, 'Dream'],
        [49.0, 19.5, 210.0, 3950.0, 1.0, 'Dream'],
        [46.2, 17.5, 187.0, 3650.0, 0.0, 'Dream'],
        [50.9, 19.1, 196.0, 3550.0, 1.0, 'Dream'],
        [45.5, 17.0, 196.0, 3500.0, 0.0, 'Dream'],
        [50.9, 17.9, 196.0, 3675.0, 0.0, 'Dream'],
        [50.8, 18.5, 201.0, 4450.0, 1.0, 'Dream'],
        [50.1, 17.9, 190.0, 3400.0, 0.0, 'Dream'],
        [49.0, 19.6, 212.0, 4300.0, 1.0, 'Dream'],
        [51.5, 18.7, 187.0, 3250.0, 1.0, 'Dream'],
        [49.8, 17.3, 198.0, 3675.0, 0.0, 'Dream'],
        [48.1, 16.4, 199.0, 3325.0, 0.0, 'Dream'],
        [51.4, 19.0, 201.0, 3950.0, 1.0, 'Dream'],
        [45.7, 17.3, 193.0, 3600.0, 0.0, 'Dream'],
        [50.7, 19.7, 203.0, 4050.0, 1.0, 'Dream'],
        [42.5, 17.3, 187.0, 3350.0, 0.0, 'Dream'],
        [52.2, 18.8, 197.0, 3450.0, 1.0, 'Dream'],
        [45.2, 16.6, 191.0, 3250.0, 0.0, 'Dream'],
        [49.3, 19.9, 203.0, 4050.0, 1.0, 'Dream'],
        [50.2, 18.8, 202.0, 3800.0, 1.0, 'Dream'],
        [45.6, 19.4, 194.0, 3525.0, 0.0, 'Dream'],
        [51.9, 19.5, 206.0, 3950.0, 1.0, 'Dream'],
        [46.8, 16.5, 189.0, 3650.0, 0.0, 'Dream'],
        [45.7, 17.0, 195.0, 3650.0, 0.0, 'Dream'],
        [55.8, 19.8, 207.0, 4000.0, 1.0, 'Dream'],
        [43.5, 18.1, 202.0, 3400.0, 0.0, 'Dream'],
        [49.6, 18.2, 193.0, 3775.0, 1.0, 'Dream'],
        [50.8, 19.0, 210.0, 4100.0, 1.0, 'Dream'],
        [50.2, 18.7, 198.0, 3775.0, 0.0, 'Dream'],
        [46.1, 13.2, 211.0, 4500.0, 0.0, 'Biscoe'],
        [50.0, 16.3, 230.0, 5700.0, 1.0, 'Biscoe'],
        [48.7, 14.1, 210.0, 4450.0, 0.0, 'Biscoe'],
        [50.0, 15.2, 218.0, 5700.0, 1.0, 'Biscoe'],
        [47.6, 14.5, 215.0, 5400.0, 1.0, 'Biscoe'],
        [46.5, 13.5, 210.0, 4550.0, 0.0, 'Biscoe'],
        [45.4, 14.6, 211.0, 4800.0, 0.0, 'Biscoe'],
        [46.7, 15.3, 219.0, 5200.0, 1.0, 'Biscoe'],
        [43.3, 13.4, 209.0, 4400.0, 0.0, 'Biscoe'],
        [46.8, 15.4, 215.0, 5150.0, 1.0, 'Biscoe'],
        [40.9, 13.7, 214.0, 4650.0, 0.0, 'Biscoe'],
        [49.0, 16.1, 216.0, 5550.0, 1.0, 'Biscoe'],
        [45.5, 13.7, 214.0, 4650.0, 0.0, 'Biscoe'],
        [48.4, 14.6, 213.0, 5850.0, 1.0, 'Biscoe'],
        [45.8, 14.6, 210.0, 4200.0, 0.0, 'Biscoe'],
        [49.3, 15.7, 217.0, 5850.0, 1.0, 'Biscoe'],
        [42.0, 13.5, 210.0, 4150.0, 0.0, 'Biscoe'],
        [49.2, 15.2, 221.0, 6300.0, 1.0, 'Biscoe'],
        [46.2, 14.5, 209.0, 4800.0, 0.0, 'Biscoe'],
        [48.7, 15.1, 222.0, 5350.0, 1.0, 'Biscoe'],
        [50.2, 14.3, 218.0, 5700.0, 1.0, 'Biscoe'],
        [45.1, 14.5, 215.0, 5000.0, 0.0, 'Biscoe'],
        [46.5, 14.5, 213.0, 4400.0, 0.0, 'Biscoe'],
        [46.3, 15.8, 215.0, 5050.0, 1.0, 'Biscoe'],
        [42.9, 13.1, 215.0, 5000.0, 0.0, 'Biscoe'],
        [46.1, 15.1, 215.0, 5100.0, 1.0, 'Biscoe'],
        [47.8, 15.0, 215.0, 5650.0, 1.0, 'Biscoe'],
        [48.2, 14.3, 210.0, 4600.0, 0.0, 'Biscoe'],
        [50.0, 15.3, 220.0, 5550.0, 1.0, 'Biscoe'],
        [47.3, 15.3, 222.0, 5250.0, 1.0, 'Biscoe'],
        [42.8, 14.2, 209.0, 4700.0, 0.0, 'Biscoe'],
        [45.1, 14.5, 207.0, 5050.0, 0.0, 'Biscoe'],
        [59.6, 17.0, 230.0, 6050.0, 1.0, 'Biscoe'],
        [49.1, 14.8, 220.0, 5150.0, 0.0, 'Biscoe'],
        [48.4, 16.3, 220.0, 5400.0, 1.0, 'Biscoe'],
        [42.6, 13.7, 213.0, 4950.0, 0.0, 'Biscoe'],
        [44.4, 17.3, 219.0, 5250.0, 1.0, 'Biscoe'],
        [44.0, 13.6, 208.0, 4350.0, 0.0, 'Biscoe'],
        [48.7, 15.7, 208.0, 5350.0, 1.0, 'Biscoe'],
        [42.7, 13.7, 208.0, 3950.0, 0.0, 'Biscoe'],
        [49.6, 16.0, 225.0, 5700.0, 1.0, 'Biscoe'],
        [45.3, 13.7, 210.0, 4300.0, 0.0, 'Biscoe'],
        [49.6, 15.0, 216.0, 4750.0, 1.0, 'Biscoe'],
        [50.5, 15.9, 222.0, 5550.0, 1.0, 'Biscoe'],
        [43.6, 13.9, 217.0, 4900.0, 0.0, 'Biscoe'],
        [45.5, 13.9, 210.0, 4200.0, 0.0, 'Biscoe'],
        [50.5, 15.9, 225.0, 5400.0, 1.0, 'Biscoe'],
        [44.9, 13.3, 213.0, 5100.0, 0.0, 'Biscoe'],
        [45.2, 15.8, 215.0, 5300.0, 1.0, 'Biscoe'],
        [46.6, 14.2, 210.0, 4850.0, 0.0, 'Biscoe'],
        [48.5, 14.1, 220.0, 5300.0, 1.0, 'Biscoe'],
        [45.1, 14.4, 210.0, 4400.0, 0.0, 'Biscoe'],
        [50.1, 15.0, 225.0, 5000.0, 1.0, 'Biscoe'],
        [46.5, 14.4, 217.0, 4900.0, 0.0, 'Biscoe'],
        [45.0, 15.4, 220.0, 5050.0, 1.0, 'Biscoe'],
        [43.8, 13.9, 208.0, 4300.0, 0.0, 'Biscoe'],
        [45.5, 15.0, 220.0, 5000.0, 1.0, 'Biscoe'],
        [43.2, 14.5, 208.0, 4450.0, 0.0, 'Biscoe'],
        [50.4, 15.3, 224.0, 5550.0, 1.0, 'Biscoe'],
        [45.3, 13.8, 208.0, 4200.0, 0.0, 'Biscoe'],
        [46.2, 14.9, 221.0, 5300.0, 1.0, 'Biscoe'],
        [45.7, 13.9, 214.0, 4400.0, 0.0, 'Biscoe'],
        [54.3, 15.7, 231.0, 5650.0, 1.0, 'Biscoe'],
        [45.8, 14.2, 219.0, 4700.0, 0.0, 'Biscoe'],
        [49.8, 16.8, 230.0, 5700.0, 1.0, 'Biscoe'],
        [49.5, 16.2, 229.0, 5800.0, 1.0, 'Biscoe'],
        [43.5, 14.2, 220.0, 4700.0, 0.0, 'Biscoe'],
        [50.7, 15.0, 223.0, 5550.0, 1.0, 'Biscoe'],
        [47.7, 15.0, 216.0, 4750.0, 0.0, 'Biscoe'],
        [46.4, 15.6, 221.0, 5000.0, 1.0, 'Biscoe'],
        [48.2, 15.6, 221.0, 5100.0, 1.0, 'Biscoe'],
        [46.5, 14.8, 217.0, 5200.0, 0.0, 'Biscoe'],
        [46.4, 15.0, 216.0, 4700.0, 0.0, 'Biscoe'],
        [48.6, 16.0, 230.0, 5800.0, 1.0, 'Biscoe'],
        [47.5, 14.2, 209.0, 4600.0, 0.0, 'Biscoe'],
        [51.1, 16.3, 220.0, 6000.0, 1.0, 'Biscoe'],
        [45.2, 13.8, 215.0, 4750.0, 0.0, 'Biscoe'],
        [45.2, 16.4, 223.0, 5950.0, 1.0, 'Biscoe'],
        [49.1, 14.5, 212.0, 4625.0, 0.0, 'Biscoe'],
        [52.5, 15.6, 221.0, 5450.0, 1.0, 'Biscoe'],
        [47.4, 14.6, 212.0, 4725.0, 0.0, 'Biscoe'],
        [50.0, 15.9, 224.0, 5350.0, 1.0, 'Biscoe'],
        [44.9, 13.8, 212.0, 4750.0, 0.0, 'Biscoe'],
        [50.8, 17.3, 228.0, 5600.0, 1.0, 'Biscoe'],
        [43.4, 14.4, 218.0, 4600.0, 0.0, 'Biscoe'],
        [51.3, 14.2, 218.0, 5300.0, 1.0, 'Biscoe'],
        [47.5, 14.0, 212.0, 4875.0, 0.0, 'Biscoe'],
        [52.1, 17.0, 230.0, 5550.0, 1.0, 'Biscoe'],
        [47.5, 15.0, 218.0, 4950.0, 0.0, 'Biscoe'],
        [52.2, 17.1, 228.0, 5400.0, 1.0, 'Biscoe'],
        [45.5, 14.5, 212.0, 4750.0, 0.0, 'Biscoe'],
        [49.5, 16.1, 224.0, 5650.0, 1.0, 'Biscoe'],
        [44.5, 14.7, 214.0, 4850.0, 0.0, 'Biscoe'],
        [50.8, 15.7, 226.0, 5200.0, 1.0, 'Biscoe'],
        [49.4, 15.8, 216.0, 4925.0, 1.0, 'Biscoe'],
        [46.9, 14.6, 222.0, 4875.0, 0.0, 'Biscoe'],
        [48.4, 14.4, 203.0, 4625.0, 0.0, 'Biscoe'],
        [51.1, 16.5, 225.0, 5250.0, 1.0, 'Biscoe'],
        [48.5, 15.0, 219.0, 4850.0, 0.0, 'Biscoe'],
        [55.9, 17.0, 228.0, 5600.0, 1.0, 'Biscoe'],
        [47.2, 15.5, 215.0, 4975.0, 0.0, 'Biscoe'],
        [49.1, 15.0, 228.0, 5500.0, 1.0, 'Biscoe'],
        [46.8, 16.1, 215.0, 5500.0, 1.0, 'Biscoe'],
        [41.7, 14.7, 210.0, 4700.0, 0.0, 'Biscoe'],
        [53.4, 15.8, 219.0, 5500.0, 1.0, 'Biscoe'],
        [43.3, 14.0, 208.0, 4575.0, 0.0, 'Biscoe'],
        [48.1, 15.1, 209.0, 5500.0, 1.0, 'Biscoe'],
        [50.5, 15.2, 216.0, 5000.0, 0.0, 'Biscoe'],
        [49.8, 15.9, 229.0, 5950.0, 1.0, 'Biscoe'],
        [43.5, 15.2, 213.0, 4650.0, 0.0, 'Biscoe'],
        [51.5, 16.3, 230.0, 5500.0, 1.0, 'Biscoe'],
        [46.2, 14.1, 217.0, 4375.0, 0.0, 'Biscoe'],
        [55.1, 16.0, 230.0, 5850.0, 1.0, 'Biscoe'],
        [44.5, 15.7, 217.0, 4875.0, 0.0, 'Biscoe'],
        [48.8, 16.2, 222.0, 6000.0, 1.0, 'Biscoe'],
        [47.2, 13.7, 214.0, 4925.0, 0.0, 'Biscoe'],
        [46.8, 14.3, 215.0, 4850.0, 0.0, 'Biscoe'],
        [50.4, 15.7, 222.0, 5750.0, 1.0, 'Biscoe'],
        [45.2, 14.8, 212.0, 5200.0, 0.0, 'Biscoe'],
        [49.9, 16.1, 213.0, 5400.0, 1.0, 'Biscoe'],
    ]),
    "wines_small": np.array([
        [7.4, 0.7, 0.0, 1.9, 0.076, 11.0, 34.0, 0.9978, 3.51, 0.56, 9.4, '5'],
        [7.8, 0.88, 0.0, 2.6, 0.098, 25.0, 67.0, 0.9968, 3.2, 0.68, 9.8, '5'],
        [7.8, 0.76, 0.04, 2.3, 0.092, 15.0, 54.0, 0.997, 3.26, 0.65, 9.8, '5'],
        [11.2, 0.28, 0.56, 1.9, 0.075, 17.0, 60.0, 0.998, 3.16, 0.58, 10.3, '6'],
        [7.4, 0.7, 0.0, 1.9, 0.076, 11.0, 34.0, 0.9978, 3.51, 0.56, 9.4, '5'],
        [7.4, 0.66, 0.0, 1.8, 0.075, 13.0, 40.0, 0.9978, 3.51, 0.56, 9.4, '5'],
        [7.9, 0.6, 0.06, 1.6, 0.069, 15.0, 59.0, 0.9964, 3.3, 0.46, 9.4, '5'],
        [7.3, 0.65, 0.0, 1.2, 0.065, 15.0, 21.0, 0.9946, 3.39, 0.47, 11.0, '7'],
        [7.8, 0.58, 0.02, 2.0, 0.073, 9.0, 18.0, 0.9968, 3.36, 0.57, 10.5, '7'],
        ...
        [8.5, 0.28, 0.56, 1.8, 0.092, 35.0, 103.0, 0.9969, 3.3, 0.75, 11.5, '7'],
        [7.9, 0.32, 0.51, 1.8, 0.341, 17.0, 56.0, 0.9969, 3.04, 1.08, 9.7, '6'],
        ...
        [6.9, 0.4, 0.14, 2.4, 0.085, 21.0, 40.0, 0.9968, 3.43, 0.63, 10.2, '6'],
        ...
        [7.8, 0.645, 0.0, 2.0, 0.0819999999999999, 8.0, 16.0, 0.9964, 3.38, 0.59, 10.3, '6'],
        ...
        [7.8, 0.645, 0.0, 5.5, 0.086, 5.0, 18.0, 0.9986, 3.4, 0.55, 10.1, '6'],
        [7.8, 0.6, 0.14, 2.4, 0.086, 3.0, 15.0, 0.9975, 3.42, 0.6, 10.2, '6'],
        [8.1, 0.38, 0.28, 2.1, 0.066, 13.0, 30.0, 0.9968, 3.23, 0.73, 10.7, '7'],
        [7.3, 0.45, 0.36, 5.9, 0.074, 12.0, 87.0, 0.9978, 3.33, 0.83, 10.5, '5'],
        [8.8, 0.61, 0.3, 2.8, 0.088, 17.0, 46.0, 0.9976, 3.26, 0.51, 8.2, '4'],
        [7.5, 0.49, 0.2, 2.6, 0.332, 8.0, 14.0, 0.9968, 3.21, 0.9, 10.5, '6'],
        [8.1, 0.66, 0.22, 2.2, 0.069, 9.0, 23.0, 0.9968, 3.3, 1.2, 10.3, '5'],
        [4.6, 0.52, 0.15, 2.1, 0.054, 8.0, 65.0, 0.9934, 3.9, 0.56, 10.4, '4'],
        [7.7, 0.935, 0.43, 2.2, 0.114, 22.0, 114.0, 0.997, 3.25, 0.73, 9.2, '5'],
        [8.8, 0.66, 0.26, 1.7, 0.074, 4.0, 23.0, 0.9971, 3.15, 0.74, 9.2, '5'],
        [6.6, 0.52, 0.04, 2.2, 0.069, 8.0, 15.0, 0.9956, 3.4, 0.63, 9.9, '6'],
        [6.6, 0.5, 0.04, 2.1, 0.068, 6.0, 14.0, 0.9955, 3.39, 0.64, 9.9, '6'],
        [8.6, 0.38, 0.36, 3.0, 0.081, 30.0, 119.0, 0.997, 3.2, 0.56, 9.4, '5'],
        [7.6, 0.51, 0.15, 2.8, 0.11, 33.0, 73.0, 0.9955, 3.17, 0.63, 10.4, '6'],
        [10.2, 0.42, 0.57, 3.4, 0.07, 4.0, 10.0, 0.9971, 3.04, 0.63, 9.6, '5'],
        [7.8, 0.59, 0.18, 2.3, 0.076, 17.0, 54.0, 0.9975, 3.43, 0.59, 10.0, '5'],
        [7.3, 0.39, 0.31, 2.4, 0.074, 9.0, 46.0, 0.9962, 3.41, 0.54, 9.9, '6'],
        ...
        [8.3, 0.675, 0.26, 2.1, 0.084, 11.0, 43.0, 0.9976, 3.31, 0.53, 8.3, '4'],
        [8.8, 0.41, 0.64, 2.2, 0.093, 9.0, 42.0, 0.9986, 3.54, 0.66, 10.5, '5'],
        [6.8, 0.785, 0.0, 2.4, 0.104, 14.0, 30.0, 0.9966, 3.52, 0.55, 10.7, '6'],
        [6.7, 0.75, 0.12, 2.0, 0.086, 12.0, 80.0, 0.9958, 3.38, 0.52, 10.1, '5'],
        [8.3, 0.625, 0.2, 1.5, 0.08, 27.0, 119.0, 0.9972, 3.16, 1.12, 8.1, '4'],
        [6.2, 0.45, 0.2, 1.6, 0.069, 3.0, 15.0, 0.9958, 3.41, 0.56, 9.2, '5'],
        [7.4, 0.5, 0.47, 2.0, 0.086, 21.0, 73.0, 0.997, 3.36, 0.57, 9.1, '5'],
        [6.3, 0.3, 0.48, 1.8, 0.069, 18.0, 61.0, 0.9959, 3.44, 0.78, 10.6, '6'],
        ...
        [8.6, 0.49, 0.28, 1.9, 0.11, 20.0, 136.0, 0.9972, 2.93, 1.95, 10.4, '6'],
        [7.7, 0.49, 0.26, 1.9, 0.062, 9.0, 31.0, 0.9966, 3.39, 0.64, 9.6, '5'],
        [5.0, 1.02, 0.04, 1.4, 0.045, 41.0, 85.0, 0.9938, 3.75, 0.48, 9.1, '4']
    ]),
    "wines": np.array([
        [7.4, 0.7, 0.0, 1.9, 0.076, 11.0, 34.0, 0.9978, 3.51, 0.56, 9.4, '5'],
        [7.8, 0.88, 0.0, 2.6, 0.098, 25.0, 67.0, 0.9968, 3.2, 0.68, 9.8, '5'],
        ...
        [6.2, 0.63, 0.31, 1.7, 0.088, 15.0, 64.0, 0.9969, 3.46, 0.79, 9.3, '5'],
        ...
        [7.3, 1.07, 0.09, 1.7, 0.178, 10.0, 89.0, 0.9962, 3.3, 0.57, 9.0, '5'],
        [8.8, 0.55, 0.04, 2.2, 0.119, 14.0, 56.0, 0.9962, 3.21, 0.6, 10.9, '6'],
        [7.3, 0.695, 0.0, 2.5, 0.075, 3.0, 13.0, 0.998, 3.49, 0.52, 9.2, '5'],
        [7.8, 0.5, 0.17, 1.6, 0.0819999999999999, 21.0, 102.0, 0.996, 3.39, 0.48, 9.5, '5'],
        [8.2, 1.33, 0.0, 1.7, 0.081, 3.0, 12.0, 0.9964, 3.53, 0.49, 10.9, '5'],
        [8.1, 1.33, 0.0, 1.8, 0.0819999999999999, 3.0, 12.0, 0.9964, 3.54, 0.48, 10.9, '5'],
        ...
        [6.9, 0.49, 0.1, 2.3, 0.074, 12.0, 30.0, 0.9959, 3.42, 0.58, 10.2, '6'],
        ...
        [7.6, 0.55, 0.21, 2.2, 0.071, 7.0, 28.0, 0.9964, 3.28, 0.55, 9.7, '5'],
        [7.3, 0.58, 0.3, 2.4, 0.074, 15.0, 55.0, 0.9968, 3.46, 0.59, 10.2, '5'],
        ...
        [7.8, 0.34, 0.37, 2.0, 0.0819999999999999, 24.0, 58.0, 0.9964, 3.34, 0.59, 9.4, '6'],
        ...
        [12.0, 0.38, 0.56, 2.1, 0.093, 6.0, 24.0, 0.99925, 3.14, 0.71, 10.9, '6'],
        ...
        [7.6, 0.62, 0.32, 2.2, 0.0819999999999999, 7.0, 54.0, 0.9966, 3.36, 0.52, 9.4, '5'],
        ...
        [12.5, 0.28, 0.54, 2.3, 0.0819999999999999, 12.0, 29.0, 0.9997, 3.11, 1.36, 9.8, '7'],
        [10.9, 0.39, 0.47, 1.8, 0.118, 6.0, 14.0, 0.9982, 3.3, 0.75, 9.8, '6'],
        [10.9, 0.39, 0.47, 1.8, 0.118, 6.0, 14.0, 0.9982, 3.3, 0.75, 9.8, '6'],
        [11.9, 0.57, 0.5, 2.6, 0.0819999999999999, 6.0, 32.0, 1.0006, 3.12, 0.78, 10.7, '6'],
        [13.8, 0.49, 0.67, 3.0, 0.093, 6.0, 15.0, 0.9986, 3.02, 0.93, 12.0, '6'],
        ...
        [7.8, 0.46, 0.26, 1.9, 0.088, 23.0, 53.0, 0.9981, 3.43, 0.74, 9.2, '6'],
        [5.6, 0.85, 0.05, 1.4, 0.045, 12.0, 88.0, 0.9924, 3.56, 0.82, 12.9, '8'],
        [13.7, 0.415, 0.68, 2.9, 0.085, 17.0, 43.0, 1.0014, 3.06, 0.8, 10.0, '6'],
        [9.5, 0.37, 0.52, 2.0, 0.0819999999999999, 6.0, 26.0, 0.998, 3.18, 0.51, 9.5, '5'],
        ...
        [9.2, 0.63, 0.21, 2.7, 0.0969999999999999, 29.0, 65.0, 0.9988, 3.28, 0.58, 9.6, '5'],
        ...
        [10.2, 0.67, 0.39, 1.9, 0.054, 6.0, 17.0, 0.9976, 3.17, 0.47, 10.0, '5'],
        ...
        [8.9, 0.4, 0.51, 2.6, 0.052, 13.0, 27.0, 0.995, 3.32, 0.9, 13.4, '7'],
        ...
        [11.9, 0.38, 0.49, 2.7, 0.098, 12.0, 42.0, 1.0004, 3.16, 0.61, 10.3, '5'],
        [10.3, 0.27, 0.24, 2.1, 0.072, 15.0, 33.0, 0.9956, 3.22, 0.66, 12.8, '6'],
        ...
        [10.9, 0.53, 0.49, 4.6, 0.118, 10.0, 17.0, 1.0002, 3.07, 0.56, 11.7, '6'],
        ...
        [12.4, 0.4, 0.51, 2.0, 0.059, 6.0, 24.0, 0.9994, 3.04, 0.6, 9.3, '6'],
        ...
        [9.2, 0.53, 0.24, 2.6, 0.078, 28.0, 139.0, 0.99788, 3.21, 0.57, 9.5, '5'],
        ...
        [7.6, 0.54, 0.13, 2.5, 0.0969999999999999, 24.0, 66.0, 0.99785, 3.39, 0.61, 9.4, '5'],
        [8.3, 0.65, 0.1, 2.9, 0.089, 17.0, 40.0, 0.99803, 3.29, 0.55, 9.5, '5'],
        ...
        [8.8, 0.59, 0.18, 2.9, 0.089, 12.0, 74.0, 0.99738, 3.14, 0.54, 9.4, '5'],
        ...
        [7.1, 0.59, 0.02, 2.3, 0.0819999999999999, 24.0, 94.0, 0.99744, 3.55, 0.53, 9.7, '6'],
        [9.4, 0.685, 0.26, 2.4, 0.0819999999999999, 23.0, 143.0, 0.9978, 3.28, 0.55, 9.4, '5'],
        ...
        [8.3, 0.43, 0.3, 3.4, 0.079, 7.0, 34.0, 0.99788, 3.36, 0.61, 10.5, '5'],
        [7.1, 0.52, 0.03, 2.6, 0.076, 21.0, 92.0, 0.99745, 3.5, 0.6, 9.8, '5'],
        [7.0, 0.57, 0.0, 2.0, 0.19, 12.0, 45.0, 0.99676, 3.31, 0.6, 9.4, '6'],
        [6.5, 0.46, 0.14, 2.4, 0.114, 9.0, 37.0, 0.99732, 3.66, 0.65, 9.8, '5'],
        ...
        [7.4, 0.37, 0.43, 2.6, 0.0819999999999999, 18.0, 82.0, 0.99708, 3.33, 0.68, 9.7, '6'],
        ...
        [9.4, 0.5, 0.34, 3.6, 0.0819999999999999, 5.0, 14.0, 0.9987, 3.29, 0.52, 10.7, '6'],
        ...
        [7.6, 0.48, 0.31, 2.8, 0.07, 4.0, 15.0, 0.99693, 3.22, 0.55, 10.3, '6'],
        [7.3, 0.49, 0.1, 2.6, 0.068, 4.0, 14.0, 0.99562, 3.3, 0.47, 10.5, '5'],
        [12.9, 0.5, 0.55, 2.8, 0.072, 7.0, 24.0, 1.00012, 3.09, 0.68, 10.9, '6'],
        [6.9, 0.39, 0.24, 2.1, 0.102, 4.0, 7.0, 0.99462, 3.44, 0.58, 11.4, '4'],
        [12.6, 0.41, 0.54, 2.8, 0.103, 19.0, 41.0, 0.99939, 3.21, 0.76, 11.3, '6'],
        [9.1, 0.66, 0.15, 3.2, 0.0969999999999999, 9.0, 59.0, 0.99976, 3.28, 0.54, 9.6, '5'],
        ...
        [7.1, 0.685, 0.35, 2.0, 0.088, 9.0, 92.0, 0.9963, 3.28, 0.62, 9.4, '5'],
        ...
        [6.9, 0.56, 0.03, 1.5, 0.086, 36.0, 46.0, 0.99522, 3.53, 0.57, 10.6, '5'],
        ...
        [8.4, 0.31, 0.29, 3.1, 0.1939999999999999, 14.0, 26.0, 0.99536, 3.22, 0.78, 12.0, '6'],
        ...
        [9.1, 0.28, 0.46, 9.0, 0.114, 3.0, 9.0, 0.99901, 3.18, 0.6, 10.9, '6'],
        ...
        [8.5, 0.21, 0.52, 1.9, 0.09, 9.0, 23.0, 0.99648, 3.36, 0.67, 10.4, '5'],
        ...
        [6.4, 0.69, 0.0, 1.65, 0.055, 7.0, 12.0, 0.99162, 3.47, 0.53, 12.9, '6'],
        ...
        [10.1, 0.37, 0.34, 2.4, 0.085, 5.0, 17.0, 0.99683, 3.17, 0.65, 10.6, '7'],
        [7.6, 0.31, 0.34, 2.5, 0.0819999999999999, 26.0, 35.0, 0.99356, 3.22, 0.59, 12.5, '7'],
        ...
        [6.9, 0.44, 0.0, 1.4, 0.07, 32.0, 38.0, 0.99438, 3.32, 0.58, 11.4, '6'],
        ...
        [8.2, 0.64, 0.27, 2.0, 0.095, 5.0, 77.0, 0.99747, 3.13, 0.62, 9.1, '6'],
        ...
        [8.9, 0.48, 0.53, 4.0, 0.1009999999999999, 3.0, 10.0, 0.99586, 3.21, 0.59, 12.1, '7'],
        [11.6, 0.23, 0.57, 1.8, 0.074, 3.0, 8.0, 0.9981, 3.14, 0.7, 9.9, '6'],
        ...
        [8.0, 0.62, 0.33, 2.7, 0.088, 16.0, 37.0, 0.9972, 3.31, 0.58, 10.7, '6'],
        ...
        [9.1, 0.6, 0.0, 1.9, 0.0579999999999999, 5.0, 10.0, 0.9977, 3.18, 0.63, 10.4, '6'],
        ...
        [7.3, 0.32, 0.23, 2.3, 0.066, 35.0, 70.0, 0.99588, 3.43, 0.62, 10.1, '5'],
        ...
        [9.2, 0.36, 0.34, 1.6, 0.062, 5.0, 12.0, 0.99667, 3.2, 0.67, 10.5, '6'],
        ...
        [6.2, 0.43, 0.22, 1.8, 0.078, 21.0, 56.0, 0.99633, 3.52, 0.6, 9.5, '6'],
        ...
        [9.0, 0.39, 0.4, 1.3, 0.044, 25.0, 50.0, 0.99478, 3.2, 0.83, 10.9, '6'],
        ...
        [7.1, 0.6, 0.01, 2.3, 0.079, 24.0, 37.0, 0.99514, 3.4, 0.61, 10.9, '6'],
        [7.5, 0.58, 0.14, 2.2, 0.077, 27.0, 60.0, 0.9963, 3.28, 0.59, 9.8, '5'],
        [7.1, 0.72, 0.0, 1.8, 0.123, 6.0, 14.0, 0.99627, 3.45, 0.58, 9.8, '5'],
        ...
        [7.1, 0.46, 0.2, 1.9, 0.077, 28.0, 54.0, 0.9956, 3.37, 0.64, 10.4, '6'],
        [7.9, 0.765, 0.0, 2.0, 0.084, 9.0, 22.0, 0.99619, 3.33, 0.68, 10.9, '6'],
        ...
        [8.2, 0.635, 0.1, 2.1, 0.073, 25.0, 60.0, 0.99638, 3.29, 0.75, 10.9, '6'],
        ...
        [9.1, 0.37, 0.32, 2.1, 0.064, 4.0, 15.0, 0.99576, 3.3, 0.8, 11.2, '6'],
        ...
        [8.0, 1.18, 0.21, 1.9, 0.083, 14.0, 41.0, 0.99532, 3.34, 0.47, 10.5, '5'],
        ...
        [9.1, 0.76, 0.68, 1.7, 0.414, 18.0, 64.0, 0.99652, 2.9, 1.33, 9.1, '6'],
        ...
        [7.5, 0.51, 0.02, 1.7, 0.084, 13.0, 31.0, 0.99538, 3.36, 0.54, 10.5, '6'],
        [7.5, 0.51, 0.02, 1.7, 0.084, 13.0, 31.0, 0.99538, 3.36, 0.54, 10.5, '6'],
        [11.5, 0.42, 0.48, 2.6, 0.077, 8.0, 20.0, 0.99852, 3.09, 0.53, 11.0, '5'],
        ...
        [6.9, 0.54, 0.3, 2.2, 0.088, 9.0, 105.0, 0.99725, 3.25, 1.18, 10.5, '6'],
        ...
        [7.2, 0.45, 0.15, 2.0, 0.078, 10.0, 28.0, 0.99609, 3.29, 0.51, 9.9, '6'],
        ...
        [8.0, 0.64, 0.22, 2.4, 0.094, 5.0, 33.0, 0.99612, 3.37, 0.58, 11.0, '5'],
        ...
        [6.0, 0.51, 0.0, 2.1, 0.064, 40.0, 54.0, 0.995, 3.54, 0.93, 10.7, '6'],
        [6.6, 0.96, 0.0, 1.8, 0.0819999999999999, 5.0, 16.0, 0.9936, 3.5, 0.44, 11.9, '6'],
        ...
        [6.4, 0.53, 0.09, 3.9, 0.123, 14.0, 31.0, 0.9968, 3.5, 0.67, 11.0, '4'],
        ...
        [10.0, 0.38, 0.38, 1.6, 0.1689999999999999, 27.0, 90.0, 0.99914, 3.15, 0.65, 8.5, '5'],
        ...
        [10.0, 0.69, 0.11, 1.4, 0.084, 8.0, 24.0, 0.99578, 2.88, 0.47, 9.7, '5'],
        ...
        [6.0, 0.64, 0.05, 1.9, 0.066, 9.0, 17.0, 0.99496, 3.52, 0.78, 10.6, '5'],
        ...
        [7.5, 0.38, 0.57, 2.3, 0.106, 5.0, 12.0, 0.99605, 3.36, 0.55, 11.4, '6'],
        [7.1, 0.27, 0.6, 2.1, 0.074, 17.0, 25.0, 0.99814, 3.38, 0.72, 10.6, '6'],
        ...
        [6.9, 0.84, 0.21, 4.1, 0.074, 16.0, 65.0, 0.99842, 3.53, 0.72, 9.23333333333333, '6'],
        ...
        [7.0, 0.56, 0.17, 1.7, 0.065, 15.0, 24.0, 0.99514, 3.44, 0.68, 10.55, '7'],
        ...
        [6.2, 0.7, 0.15, 5.1, 0.076, 13.0, 27.0, 0.99622, 3.54, 0.6, 11.9, '6'],
        [6.8, 0.67, 0.15, 1.8, 0.118, 13.0, 20.0, 0.9954, 3.42, 0.67, 11.3, '6'],
        ...
        [6.3, 0.55, 0.15, 1.8, 0.077, 26.0, 35.0, 0.99314, 3.32, 0.82, 11.6, '6'],
